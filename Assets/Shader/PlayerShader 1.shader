...
Shader "Shader Forge/PlayerShader" {
    Properties {
        ...
        _node_8262 ("node_8262", Range(0, 4)) = 2.769231
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
